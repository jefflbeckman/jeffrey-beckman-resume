...
\\[-0.2cm]
	...
	\item Helped customers debug difficult problems related to embedded programming on ARM, PowerPC, and x86, requiring an in-depth knowledge of the hardware, C language, and operating system concepts
...
\begin{itemize}
\item \noindent \textbf{Languages} (C, C++, Java, Python, Asm, Shell)  \textbf{OS} (INTEGRITY, Contiki, TinyOS, Linux, Windows) \textbf{Arch} (ARM, PowerPC, x86, MIPS, Coldfire) \textbf{Tools} (git, svn, gdb, EAGLE, MATLAB, Maple, SPICE)
\end{itemize}
%-----------------------------------------------------------
